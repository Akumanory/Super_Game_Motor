...
//void UpdatedModel::SetTexture(ID3D11ShaderResourceView* texture)
//{
//	this->texture = texture;
//}

void UpdatedModel::Draw(const XMMATRIX& worldMatrix, const XMMATRIX& viewProjectionMatrix)
{
...
bool UpdatedModel::LoadModel(const std::string& filePath)
{
...
TextureStorageType UpdatedModel::DetermineTextureStorageType(const aiScene* pScene, aiMaterial* pMat, unsigned int index, aiTextureType textureType)
{
...
std::vector<Texture> UpdatedModel::LoadMaterialTextures(aiMaterial* pMaterial, aiTextureType textureType, const aiScene* pScene)
{
